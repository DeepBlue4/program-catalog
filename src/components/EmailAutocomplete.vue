...
const filteredEmails = computed(() => {
  ...
  return store.state.emails.filter(email => 
...
<template>
  <div class="email-autocomplete-wrapper" :class="{ 'has-error': error, 'is-disabled': disabled }">
    ...
    <div class="input-container">
      ...
      <div class="icon-actions">
        <button v-if="searchQuery && !disabled" @click="clearInput" class="btn-icon-input" title="Clear">
      ...
      <transition name="fade-slide">
        <div v-if="showDropdown && filteredEmails.length > 0" class="suggestions-dropdown m3-card elevated">
           <div 
